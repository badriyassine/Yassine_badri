                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-3">
                      <a
                        ...
                        className="flex-1 bg-[#ff734d] hover:bg-[#ff734d]/80 text-white px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105 active:scale-95 shadow-lg"
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 bg-transparent border-2 border-[#ff734d] text-[#ff734d] hover:bg-[#ff734d] hover:text-white px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105 active:scale-95"
                        onClick={(e) => e.stopPropagation()}
                      >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex gap-2">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 bg-[#ff734d] hover:bg-[#ff734d]/80 text-white px-3 py-2 rounded-lg text-xs font-semibold transition-all duration-300 flex items-center justify-center gap-1.5 hover:scale-105 active:scale-95 shadow-lg"
                        onClick={(e) => e.stopPropagation()}
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 bg-transparent border-2 border-[#ff734d] text-[#ff734d] hover:bg-[#ff734d] hover:text-white px-3 py-2 rounded-lg text-xs font-semibold transition-all duration-300 flex items-center justify-center gap-1.5 hover:scale-105 active:scale-95"
                        onClick={(e) => e.stopPropagation()}
                      >
